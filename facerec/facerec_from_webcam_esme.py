...
# Add the pre encoded files
for filename in ['photos_2018', 'photos_2019']:
    new_known_face_encodings, new_known_face_names = extract_image.load(filename)
    known_face_encodings += new_known_face_encodings
    known_face_names += new_known_face_names
